...
- 在 [stream-overview](stream-overview.md#streamduplex) 有提到 `net.Socket` 繼承 `stream.Duplex`，故包含 `Readable` 跟 `Writable` 的所有 methods
