...
回到 2015 年的 [RFC7540 #section-3.2](https://datatracker.ietf.org/doc/html/rfc7540#section-3.2)，有說到 HTTP/2 Over HTTP 的協商機制
...
將 `AAMAAABkAAQAoAAAAAIAAAAA` 嘗試解出來

```js
console.log(Buffer.from("AAMAAABkAAQAoAAAAAIAAAAA", "base64url"));
// <Buffer 00 03 00 00 00 64 00 04 00 a0 00 00 00 02 00 00 00 00>
```
...
根據 [RFC 9113 section-6.5.1](https://datatracker.ietf.org/doc/html/rfc9113#section-6.5.1)
...
## Node.js HTTP/2 Over HTTPS

根據之前寫的文章 [mkcert 建立本機 CA](./strict-transport-security.md#mkcert-建立本機-ca)，建立好憑證
...
根據 [Node.js http2 官方文件](https://nodejs.org/api/http2.html)，畫出以下 classDiagram
